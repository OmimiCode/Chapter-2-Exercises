...
/*2.28 (Diameter, Circumference and Area of a Circle) Here’s a peek ahead. In this chapter, you
        ...
        value that will be output in a System.out.printf statement. The values produced by the circumference and
        area calculations are floating-point numbers. Such values can be output with the for-
...
public class Exercise2_28 {
    public static void main(String[] args) {
        ...
        System.out.printf( "%s%d%s%f%s%f%n","the diameter of the circle is ", 2*radius," with a circumference of ", 2*Math.PI*radius, " and an area of ",  Math.PI*radius*radius );
